...
import { CategoryAttributes, CategoryAttributesCreation, CategoryAttributesUpdate } from '../types/models/category.types'
...
import { CategorizableType } from '../types/models/categorizable.types'
