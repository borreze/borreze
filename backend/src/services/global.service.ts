...
import { modelBuildUrl } from '../utils/model.utils'
...
export class GlobalService {
  public async search(options?: { query?: string }): Promise<Record<string, unknown>[]> {
    ...
    for (const el of elements) {
      ...
      el._links = { self_front: modelBuildUrl(links.self_front || null, el), self_api: modelBuildUrl(links.self_api || null, el), list_front: modelBuildUrl(links.list_front || null, el), list_api: modelBuildUrl(links.list_api || null, el), }
