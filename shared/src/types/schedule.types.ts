...
export const SCHEDULE_TYPES_KEYS = ['town_hall', 'post', 'school_childcare'] as const
...
export const SCHEDULE_TYPES_OBJECTS: { value: ScheduleType, label: string, icon?: string }[] = [
    ...
    { value: 'post', label: 'Post', icon: 'ic:baseline-store' },
...
export type ScheduleAttributesCreation = Optional<ScheduleAttributes, 'id' | 'post_id' | 'created_at' | 'updated_at'>
export type ScheduleAttributesUpdate = Optional<ScheduleAttributes, 'id' | 'type' | 'post_id' | 'day' | 'intervals' | 'created_at' | 'updated_at'>