...
npm run seed:models ; npm run seed:files # Will run the seeder and populate the database with initial data from the seeds/ directory.
npm run cron:run # Will run cron jobs
```
